...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/10/01 18:51:58 by jumoncad          #+#    #+#             */
/*   Updated: 2023/10/24 11:41:58 by jumoncad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (is_retangular(game->map) && is_walls(game->map)
		&& is_characte_pec(game) && valid_characters(game->map))
		return (1);
	return (0);
}
